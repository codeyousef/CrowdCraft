...
export const DebugOverlay: React.FC<DebugOverlayProps> = ({ messages }) => {
  return (
    <div className="fixed top-20 right-4 bg-surface/90 backdrop-blur rounded-lg p-4 w-96 max-h-[500px] overflow-y-auto shadow-lg border border-border z-50\" style={{ display: 'block' }}>
